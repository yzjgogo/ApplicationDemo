        ...
        RxTextView.textChanges(mEdit)
                ...
                .flatMap(new Func1<List<String>, Observable<String>>() {
                    ...
                    public Observable<String> call(List<String> strings) {
                        Log.e("yin","第二："+Thread.currentThread().getName());
                        //模拟出错，执行下面的Action1<Throwable>
//                        String str = null;
//                        str.toString();
                ...
                //这里切换成主线程，不然没法操作组件
                .observeOn(AndroidSchedulers.mainThread())//决定了下面代码执行的线程
                //这里做一些过滤动作
                .filter(new Func1<String, Boolean>() {
                    @Override
                    public Boolean call(String s) {
                        Log.e("yin","第三："+Thread.currentThread().getName());
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String s) {
                        Log.e("yin","第四："+Thread.currentThread().getName());
                        //这里展示提示数据
                        mText.append(s + "\n");
                    }
                    ...
                    public void call(Throwable throwable) {
                        Log.e("yin","第五："+Thread.currentThread().getName());
                        Log.e("yin",throwable.getMessage().toString());
                    }
                });
